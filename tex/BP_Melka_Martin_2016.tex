...
Uvedený přehled není vyčerpávající, věnuji se jen některým z těch nejznámějších řešení. 
	...
	\section{Řešení pro firmy}
		Řešení této kategorie se zaměřují na větší počet uživatelů a mimo základní správy úkolů nabízí často mnoho dalších funkcí pro integraci s dalšími systémy. Používají se zejména v oblasti vývoje software, ale dají se využít i v jiných oblastech.
	...
	\section{Řešení pro jednotlivce}
		...
		\subsection{Google Inbox Reminders}
			\cite{ginbox}
		\subsection{Poznámky v telefonu, kalendář}
	...
	\begin{threeparttable}
		\begin{tabular}{|c||c|c|c|c|c|c|c|c|c|c|}
			\hline
			      & JIRA & Bugzilla & Redmine & Trackie & Trello & FogBugz & Todoist & Toodledo & Inbox & Poznámky \\ \hline \hline
			Kr. 1 & + & + & + & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
			Kr. 2 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
			Kr. 3 & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
			Kr. 4 & ~ & * & * & ~ & ~ & ~ & ~ & ~ & ~ & ~ \\ \hline
