...
\chapter{Analýza}
	...
	\section{Požadavky na aplikaci}
		...
		\begin{enumerate}
			\item \textbf{Uživatel}
			\begin{enumerate}
				\item Jako uživatel chci mít svůj účet, abych mohl spravovat své úkoly a pracovní skupiny.
				...
				\item Jako uživatel chci vytvářet úkoly a sdílet je s ostatními uživateli, abych nezapomněl na své nebo týmové úkoly, které je potřeba vypracovat.
				\item Jako uživatel chci měnit úkoly, které jsem vytvořil, abych mohl reagovat na případné změny.
				...
				\item Jako uživatel chci zobrazit všechny úkoly, kterých jsem součástí -- moje osobní i sdílené se mnou nebo pracovní skupinou, již jsem členem -- abych měl přehled o tom, co je potřeba udělat. Zobrazení by mělo jít filtrovat a řadit podle různých kritérií.
				...
				\item Jako uživatel chci zakládat pracovní skupiny a po založení se stát jejich adminem, abych se mohl sdružovat s dalšími uživateli a pracovat společně.
