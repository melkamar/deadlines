...
public interface GroupRepository 
  ...
  select group0_.group_id as group_id1_1_, 
	...
	Dotazy mohou být i složitější, jako je tomu u metody \texttt{findByMembers\_User}. Ta vrátí seznam všech skupin, jichž je uživatel členem. V jejím \uv{přeloženém} SQL tvaru jsou automaticky vygenerovány potřebné \textit{joins}.
