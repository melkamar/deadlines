...
\begin{conclusion}
	...
	Jelikož se jedná jen o serverovou část aplikace bez grafického rozhraní, je možnost jejího využití uživateli v současné podobě omezena. Představuje ale základní stavební prvek s dobře definovaným způsobem komunikace, který lze rozšiřovat a integrovat s dalšími klientskými moduly.
