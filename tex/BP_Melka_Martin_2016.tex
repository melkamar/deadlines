...
\chapter{Návrh řešení}
	...
	\section{REST API}
		...
		\subsection{REST API aplikace Deadlines}
			...
			% TODO - číslovat endpointy a pak udělat tabulku pokrytí usecases tímhle API.
			\hfill \\
			...
			\subsubsection{\texttt{/group [GET, POST]}}
			
			\subsubsection{\texttt{/group/\{group\_id\} [GET, PUT, DELETE]}}
			
			\subsubsection{\texttt{/group/manager/invite/\{group\_id\} [POST, DELETE]}}
			
			\subsubsection{\texttt{/group/manager/offer/task [GET]}}
			
			\subsubsection{\texttt{/group/manager/removetask/\{group\_id\}/\{task\_id\} [POST]}}
