				...
				\begin{Verbatim}[obeytabs,tabsize=2]
{
	...
	\subsection{Architektura Deadlines}	
		Aplikaci navrhuji podle vzoru vícevrstvé architektury. Tu tvoří několik vrstev, z nichž každá je zodpovědná za jinou funkcionalitu. Způsob komunikace mezi vrstvami je definován rozhraním, které nabízí. Je tak snazší oddělit konkrétní implementaci vrstev od jejich okolí. Výhodou této architektury je možnost poměrně pohodlně měnit konkrétní implementaci dané vrstvy (zejména v kombinaci s použitím \textit{IoC}) a to bez zásahů do vrstev, které s ní komunikují.
