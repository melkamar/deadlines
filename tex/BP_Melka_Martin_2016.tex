		...
		\subsection{Případy užití}
			...
			\begin{description}
				...
				\item[UC 2.15 Filtrovat skupiny] \hfill \\
					Umožňuje filtrovat skupiny podle toho, jestli je uživatel jejich Členem.
...
\chapter{Návrh řešení}
	...
	\section{REST API}
		...
		\subsection{REST API aplikace Deadlines}
			...
			Pokud není uvedeno jinak, všechna volání API musí být autentifikovaná použitím \textit{HTTP Basic Access Authentication}. \cite{http-basic-auth}
			...
			\subsubsection{\texttt{/task/\{task\_id\} [GET, PUT]}}
				...
				PUT upraví úkol se zadaným ID. Dostupné jen Pracovníkům úkolu.
			
			
			\subsubsection{\texttt{/task/share/\{task\_id\} [POST]}}
				POST zašle nabídku na sdílení úkolu předaným uživatelům a skupinám. Dostupné jen Pracovníkům úkolu.
