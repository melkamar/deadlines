...
public void userEditTest() throws Exception {
	...
	\section{Výsledky testování}
		Celkem jsem při implementaci aplikace napsal více než 130 testovacích případů. Testy jsem nepsal pro všechny třídy a všechny jejich metody, ale jen pro ty, které byly svou funkcí netriviální. Testy pokrývají všechny vytyčené funkce, které má aplikace nabízet, jak je popisují případy užití v sekci \ref{sec:usecases}. 
		
		Výsledná aplikace, přiložená k této práci, prošla 100\% automatizovaných testů a neobsahuje tak žádné známé chyby.
		
		Případné chyby, které nebyly zachyceny automatizovanými testy, by mohly být odhaleny testováním samotnými uživateli. Takové testování jsem neprovedl, protože aplikace disponuje pouze rozhraním REST. Nenabízí žádné grafické rozhraní, které by mohlo být použité k testování i technicky nevzdělanými uživateli.
...
\begin{conclusion}
	...
	Tady odstavce o jednotlivých bodech v metodice... %TODO
