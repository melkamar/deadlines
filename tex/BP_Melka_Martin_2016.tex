...
\chapter{Slovník pojmů}
	\begin{itemize}
		\item[] \textbf{Deadline} 
		<todo vysvětlení aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa>
		
		\item[] \textbf{Assignee} 
		<todo vysvětlení aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa>
		\item[] \textbf{Closed source}
		\item[] \textbf{Gamifikace}
		\item[] \textbf{Backend}		
		\item[] \textbf{Manhour}
	\end{itemize}
...
\chapter{Analýza}
	...
	\section{Případy užití}
		...
		\subsection{Seznam účastníků}
			Aplikace bude rozlišovat účastníky na základě několika kritérií a těm bude dostupné různé množství funkcí. Účastníci jsou zobrazeni na obrázku \textbf{TODO USER DIAGRAM}
