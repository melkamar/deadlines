...
\chapter{Analýza}
	...
	\section{Požadavky na aplikaci}
		Požadavky na aplikaci popíšu pomocí user stories (uživatelské příběhy)\cite{user-stories}. Jedná se o jednoduchý způsob, jakým vyjádřit požadavek na aplikaci z pohledu jejího uživatele (stakeholder). Měl by být krátký a napsán samotným uživatelem budoucí aplikace, v jeho terminologii.
		...
		\end{center}
		Pomocí user stories lze testovat funkčnost výsledné aplikace. Pokud jsou všechny user stories uspokojeny, pak je aplikace z hlediska funkčnosti hotova.
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\item Jako uživatel chci zobrazovat profily ostatních a vidět jejich e-mail, pokud je veřejný, abych je mohl kontaktovat.
				
				\item Jako uživatel si chci vybrat, zda umožním ostatním uživatelům vidět můj e-mail, abych mohl chránit své soukromí.
				...
				\item Jako uživatel chci vytvářet úkoly a sdílet je s ostatními uživateli a pracovními skupinami, abych nezapomněl na své nebo týmové úkoly, které je potřeba vypracovat. Úkol bude obsahovat následující informace:
				\begin{itemize}
					\item Název
					\item Popis
					\item Datum a čas začátku
					\item Datum a čas \textit{deadlinu}
				...
				\item Jako uživatel chci měnit úkoly, které jsem vytvořil, abych mohl reagovat na případné změny. Změnit budu moct všechny údaje, kromě jeho typu.
				...
				\item Jako uživatel chci na úkolu, jehož jsem součástí, zaznamenávat odvedenou práci, abych měl já i mí spolupracovníci lepší představu o tom, kolik práce na něm zbývá.
				
				\item Jako uživatel chci úkol, jehož jsem součástí, prohlašovat za splněný, uzavřený, nebo znovuotevřený, abych dal najevo, v jakém stavu se úkol nachází.
	...
	\section{Případy užití}
		...
		\subsection{Účastníci}
			...
			\begin{description}
				...
				\item[Přihlášený uživatel] \hfill \\ 
					Uživatel se stane přihlášením po zadání svého jména a hesla. Jsou mu dostupné funkce aplikace a může ji používat.
				...
				\item[Manažer skupiny] \hfill \\ 
					Uživatel je Manažer skupiny, pokud mu Admin dal tuto roli. Jako Manažer má více privilegií pro správu skupiny.
				
				\item[Admin skupiny] \hfill \\ 
					Uživatel je Admin skupiny, pokud ji založil, nebo mu současný Admin dal tuto roli. Jako Admin má nejvyšší privilegia ve skupině a tato role v rámci skupiny patří vždy právě jednomu uživateli.
					
				\item[Účastník úkolu] \hfill \\
					Účastník úkolu je abstraktní účastník. Reprezentuje uživatele, který je součástí úkolu v jako jeden z účastníků, kteří od tohoto dědí.
		...
		USECASE - zmáčknout tlačítko pro start počítání odpracované doby, pak tlačítkem vypnout. Nebo rovnou ručně zadat.
	
		\begin{figure}\centering
			\includegraphics[width=0.7\textwidth]{ea-diagrams/actors.png}
		...
		\begin{enumerate}
			...
			\item Číslovaný seznam usecases
			\item U zajímavých usecases rozepsaný detailnější scénář, případně activity diagram
		\end{enumerate}
