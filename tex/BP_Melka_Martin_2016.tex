...
\chapter{Návrh řešení}
	...
	\section{REST API}
		...
		\subsection{REST API aplikace Deadlines}
			...
			Každý \textit{endpoint} odpovídá na požadavek odpovědí, která obsahuje HTTP kód popisující, jak volání dopadlo, a případně tělo ve formátu JSON. Odpovědi od aplikace mohou mít následující kódy:
			\begin{description}
